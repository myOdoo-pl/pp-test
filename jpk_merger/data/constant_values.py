...
CELLS_DICT_VAT_7_18 = OrderedDict([
    ...
    ('P_40', {
        'plus': [
            'P_10', 'P_11', 'P_13', 'P_15', 'P_17', 'P_19', 'P_21', 'P_22',
            'P_23', 'P_25', 'P_27', 'P_29', 'P_31', 'P_32', 'P_34'
        ]
    }),
    ('P_41', {
        'plus': [
            'P_16', 'P_18', 'P_20', 'P_24', 'P_26', 'P_28',
            'P_30', 'P_33', 'P_35', 'P_36', 'P_37'
        ], 'minus': ['P_38', 'P_39']
    }),
    ('P_42', 0),
    ('P_43', 0),
...
CELLS_DICT = OrderedDict([
    ...
    ('P_51', {
        'plus': [
            'P_42', 'P_44', 'P_46', 'P_47', 'P_48', 'P_49', 'P_50'
        ]
    }),
    ('P_52', 0),
    ('P_53', 0),
...
CELLS_DICT_VDEK = OrderedDict([
    ...
    ('P_37', {
        'plus': [
            'P_10', 'P_11', 'P_13', 'P_15', 'P_17', 'P_19', 'P_21',
            'P_22', 'P_23', 'P_25', 'P_27', 'P_29', 'P_31'
        ]
    }),
    ('P_38', {
        'plus': [
            'P_16', 'P_18', 'P_20', 'P_24', 'P_26',
            'P_28', 'P_30', 'P_32', 'P_33', 'P_34'
        ],
        'minus': ['P_35', 'P_36']
    }),
    ('P_39', 0),
    ...
    ('P_47', 0),
    ('P_48', {
        'plus': ['P_39', 'P_41', 'P_43', 'P_44', 'P_45', 'P_46', 'P_47']
    }),
    ('P_49', 0),
    ('P_50', 0),
    ('P_51', 0),
